...
export const metadata: Metadata = {
  title: "Next.js Avatars | Chart Pilot - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Chart Pilot - Next.js Tailwind CSS Admin Dashboard Template",
};
