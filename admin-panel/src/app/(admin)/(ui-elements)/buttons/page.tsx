...
export const metadata: Metadata = {
  title: "Next.js Buttons | Chart Pilot - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Chart Pilot - Next.js Tailwind CSS Admin Dashboard Template",
};
