...
import { IMemberActivityHistory } from "@/action/memberHistory/memberHistoryAction";
...
const TableAction = ({ data }: { data: IMemberActivityHistory }) => {
  ...
  return (
    <div className="flex gap-2 items-center w-full justify-center">
      ...
      <GenericDetailsModal
        ...
        description="Details of the member action performed"
        data={{
...
export const MemberActivityHistoryColumn = (): ColumnConfig<any>[] => {
